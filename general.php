                ...
                <div class="panel panel-babcock">
                    <div  class="panel-heading">COVID-19 ANALYSIS IN NIGERIA AS AT <?php  $date = time(); echo date('m/d/Y', $date); ?>  
                        <div class="pull-right">
                            <a type="button" title="Visual Tools" href="visuals/time.php"><span class="fa fa-plus-square fa-2x" style="color: #fff;"></span></a> 
...
echo '</table>';
					...
					<table id="myTable" id="myTable"class="table table-default mb30 table-striped table-bordered">
					 <thead>
					<tr><th onclick="sortTable(0)">State</th><th onclick="sortTable(1)">Total Confirmed Cases</th><th>Total Active Cases</th><th>Discharged</th><th>Death</th></tr>
