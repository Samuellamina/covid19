...
$state1 = $x['data']['states'][2]['state'];
		$confirmedCases1 = $x['data']['states'][2]['confirmedCases'];
		$casesOnAdmission = $x['data']['states'][2]['casesOnAdmission'];
		$discharged = $x['data']['states'][2]['discharged'];
		$death = $x['data']['states'][2]['death'];
