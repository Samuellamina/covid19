...
$state1 = $x['data']['states'][9]['state'];
		$confirmedCases1 = $x['data']['states'][9]['confirmedCases'];
		$casesOnAdmission = $x['data']['states'][9]['casesOnAdmission'];
		$discharged = $x['data']['states'][9]['discharged'];
		$death = $x['data']['states'][9]['death'];
