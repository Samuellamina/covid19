...
$state1 = $x['data']['states'][3]['state'];
		$confirmedCases1 = $x['data']['states'][3]['confirmedCases'];
		$casesOnAdmission = $x['data']['states'][3]['casesOnAdmission'];
		$discharged = $x['data']['states'][3]['discharged'];
		$death = $x['data']['states'][3]['death'];
