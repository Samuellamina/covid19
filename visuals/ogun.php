...
$state1 = $x['data']['states'][7]['state'];
		$confirmedCases1 = $x['data']['states'][7]['confirmedCases'];
		$casesOnAdmission = $x['data']['states'][7]['casesOnAdmission'];
		$discharged = $x['data']['states'][7]['discharged'];
		$death = $x['data']['states'][7]['death'];
