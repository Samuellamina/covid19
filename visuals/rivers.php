...
$state1 = $x['data']['states'][4]['state'];
		$confirmedCases1 = $x['data']['states'][4]['confirmedCases'];
		$casesOnAdmission = $x['data']['states'][4]['casesOnAdmission'];
		$discharged = $x['data']['states'][4]['discharged'];
		$death = $x['data']['states'][4]['death'];
