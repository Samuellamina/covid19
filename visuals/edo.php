...
$state1 = $x['data']['states'][6]['state'];
		$confirmedCases1 = $x['data']['states'][6]['confirmedCases'];
		$casesOnAdmission = $x['data']['states'][6]['casesOnAdmission'];
		$discharged = $x['data']['states'][6]['discharged'];
		$death = $x['data']['states'][6]['death'];
