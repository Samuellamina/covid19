...
$state1 = $x['data']['states'][5]['state'];
		$confirmedCases1 = $x['data']['states'][5]['confirmedCases'];
		$casesOnAdmission = $x['data']['states'][5]['casesOnAdmission'];
		$discharged = $x['data']['states'][5]['discharged'];
		$death = $x['data']['states'][5]['death'];
