...
$state1 = $x['data']['states'][1]['state'];
		$confirmedCases1 = $x['data']['states'][1]['confirmedCases'];
		$casesOnAdmission = $x['data']['states'][1]['casesOnAdmission'];
		$discharged = $x['data']['states'][1]['discharged'];
		$death = $x['data']['states'][1]['death'];
