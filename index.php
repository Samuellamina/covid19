...
//$name = $row['Name'];	
	...
	if (($username =='Maria') &&($password =='Admin')) {
        ...
        <section>
            ...
            <div class="panel panel-signin">
                <div class="panel-body">
                    ...
                    <br />
                    <h4 class="text-center mb5">COVID-19 DATA ANALYSIS SYSTEM</h4>
                ...
                <div class="panel-footer">
                    <a href="signup.html" class="btn btn-timi btn-block">Copyright 2021 Maria and co </a>
                </div><!-- panel-footer -->
            </div><!-- panel -->
