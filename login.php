...
<head>
        ...
        <title>Java Program Debugging System</title>
        ...
        <section>
            ...
            <div class="panel panel-signin">
                <div class="panel-body">
                    ...
                    <br />
                    <h4 class="text-center mb5">Java Program Debugging System</h4>
                    <h4 class="text-center mb5">User Login?</h4>
                ...
                <div class="panel-footer">
                    <a href="signup.html" class="btn btn-timi btn-block">Copyright 2019 Denise and co </a>
                </div><!-- panel-footer -->
            </div><!-- panel -->
